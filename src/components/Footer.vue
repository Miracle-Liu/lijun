...
<script>
import item1 from '../static/images/dianhua.png'
import item2 from '../static/images/youjian.png'
import item3 from '../static/images/dianhua 拷贝.png'
...
.footer {
  ...
  .top {
    ...
    .item {
      ...
      float: left;
      &:nth-last-of-type(2) {
        background: rgba(40, 147, 199, 1);
      }
      &:nth-last-of-type(1) {
        background: rgba(29, 114, 158, 1);
      }
    }
  }
  .bottom {
